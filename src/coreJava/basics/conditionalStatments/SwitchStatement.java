    ...
    static void main(String[] args) {
        ...
        */
        ...
        /*
         ...
         So, to shift the code into and switch and the matching condition is at 2nd position/case it will jump into that,
         but suppose there are more conditions as well after it those conditions will also be executed.
         to avoid it and actually make the switch for optimization we need to use the break statement inside the matching ones
